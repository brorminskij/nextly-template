      ...
      {({ open }) => (
        <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
          ...
          <DisclosureButton
            ...
            className="px-2 py-1 ml-auto text-gray-500 rounded-md lg:hidden hover:text-emerald-600 focus:text-emerald-600 focus:bg-emerald-100 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700"
          >
            <svg
